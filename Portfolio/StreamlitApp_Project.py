...
def display_explanation(input_df, session, aws_bucket):
    ...
    preprocessing_pipeline = best_pipeline.named_steps['feature_selection'] #Pipeline(steps=best_pipeline.steps[:-4])
    ...
    shap.plots.waterfall(shap_values[0, :, 0])  # class 1 = fraud
    st.pyplot(fig)
